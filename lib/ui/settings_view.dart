    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          const _ScriptExecutorPathsSection(),
          ListTile(
...
class _ScriptExecutorPathsSection extends StatefulWidget {
  const _ScriptExecutorPathsSection();

  @override
  State<_ScriptExecutorPathsSection> createState() =>
      _ScriptExecutorPathsSectionState();
}

class _ScriptExecutorPathsSectionState
    extends State<_ScriptExecutorPathsSection> {
